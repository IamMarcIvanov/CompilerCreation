...
def main():
    ...
    files = namedtuple('file_locations', ['read_cfg',
                                          'write_productions',
                                          'write_first',
                                          'write_follow',
                                          'write_table',
                                          'write_actionTable_loc',
                                          'path_to_Neuspeak_Code',
                                          'lexer_output_path',
    ...
    F = files(
        r'D:\Mimisbrunnr\Github Repositories\CompilerCreation\Assignment 2\CFG_scratch.txt',
        r'D:\Mimisbrunnr\Github Repositories\CompilerCreation\Assignment 2\prod.txt',
        r'D:\Mimisbrunnr\Github Repositories\CompilerCreation\Assignment 2\first.txt',
        r'D:\Mimisbrunnr\Github Repositories\CompilerCreation\Assignment 2\follow.txt',
        r'D:\Mimisbrunnr\Github Repositories\CompilerCreation\Assignment 2\table.txt',
        r'D:\Mimisbrunnr\Github Repositories\CompilerCreation\Assignment 2\Submission\actionTable{}.txt'.format(file_letter),
        r"D:\Mimisbrunnr\Github Repositories\CompilerCreation\Assignment 2\Submission\file{}.nspk".format(file_letter),
        r"D:\Mimisbrunnr\Github Repositories\CompilerCreation\Assignment 2\Submission\op{}.txt".format(file_letter),
        r'D:\Mimisbrunnr\Github Repositories\CompilerCreation\Assignment 2\first_follow_table2.txt')
    
    
    
    pObj = Parser(F[6], F[7], F[0], F[1], F[2], F[3], F[4], F[5], F[8])
    r = pObj.root
    ...
    print('\n\n'.join([drawTree2(False)(False)(treeString)]))
